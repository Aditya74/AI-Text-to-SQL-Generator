...
Business users often know what data they need but may not know SQL.
This project helps users generate SQL queries automatically from natural language inputs.

The system:

Accepts database schema and user questions
